				...
				<div class="modal-body">
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							<label for="create-clueOwner" class="col-sm-2 control-label" id="sreach-owner">所有者<span style="font-size: 15px; color: red;">*</span></label>
							<div class="col-sm-10" style="width: 300px;">
								<select class="form-control" id="create-owner">

								</select>
							</div>
							<label for="create-company" class="col-sm-2 control-label" id="search-company">公司<span style="font-size: 15px; color: red;">*</span></label>
							<div class="col-sm-10" style="width: 300px;">
						...
						<div class="form-group">
							...
							<label for="create-surname" class="col-sm-2 control-label" id="search-fullname">姓名<span style="font-size: 15px; color: red;">*</span></label>
							<div class="col-sm-10" style="width: 300px;">
						...
						<div class="form-group">
							<label for="create-phone" class="col-sm-2 control-label" id="search-phone">公司座机</label>
							<div class="col-sm-10" style="width: 300px;">
						...
						<div class="form-group">
							<label for="create-mphone" class="col-sm-2 control-label" id="search-mphone">手机</label>
							<div class="col-sm-10" style="width: 300px;">
								<input type="text" class="form-control" id="create-mphone">
							</div>
							<label for="create-status" class="col-sm-2 control-label" id="search-state">线索状态</label>
							<div class="col-sm-10" style="width: 300px;">
						...
						<div class="form-group">
							<label for="create-source" class="col-sm-2 control-label" id="search-source">线索来源</label>
							<div class="col-sm-10" style="width: 300px;">
		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div class="btn-toolbar" role="toolbar" style="background-color: #F7F7F7; height: 50px; position: relative;top: 40px;">
				<div class="btn-group" style="position: relative; top: 18%;">
				  ...
				  <button type="button" class="btn btn-default"  data-target="#editClueModal" id="editBtn"><span class="glyphicon glyphicon-pencil"></span> 修改</button>
				...
				<table class="table table-hover">
					...
					<tbody id="clueBody">
						...
						<tr>
							...
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/clue/detail.do?id=8e9319b9d2674afd9f7c48747f2ba6b9';">马云</a></td>
							<td>格力集团</td>
							<td>021-33333333</td>
							<td>13333333333</td>
							<td>公开媒介 </td>
